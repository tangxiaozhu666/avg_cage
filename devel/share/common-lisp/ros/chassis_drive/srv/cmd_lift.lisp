...
(cl:in-package chassis_drive-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <cmd_lift-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cmd_lift-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name chassis_drive-srv:<cmd_lift-request> is deprecated: use chassis_drive-srv:cmd_lift-request instead.")))

(cl:ensure-generic-function 'lift_active-val :lambda-list '(m))
(cl:defmethod lift_active-val ((m <cmd_lift-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chassis_drive-srv:lift_active-val is deprecated.  Use chassis_drive-srv:lift_active instead.")
  (lift_active m))
...
(cl:defmethod cl:initialize-instance :after ((m <cmd_lift-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cmd_lift-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name chassis_drive-srv:<cmd_lift-response> is deprecated: use chassis_drive-srv:cmd_lift-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<cmd_lift-response>)))
  ...
  "chassis_drive/cmd_liftResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'cmd_lift-response)))
  "Returns string type for a service object of type 'cmd_lift-response"
  "chassis_drive/cmd_liftResponse")
